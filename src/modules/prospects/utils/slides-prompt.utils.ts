...
export function buildSlidesResearchContext(prospect: Prospect, publicUrl?: string | null) {
  return [
    ...
    '- website oficial',
    '- logo visible dentro del website oficial si existe',
    '- Instagram oficial',
    ...
    'Si el sitio web existe, intenta extraer el logo y conviértelo en referencia principal del deck.',
    'Si el sitio web tiene logo verificable, los slides deben pedirse y pensarse con ese logo como activo prioritario.',
...
export function buildSlidesOutputInstructions() {
  return [
    ...
    '- si el website existe y el logo es visible allí, úsalo como referencia obligatoria del deck',
